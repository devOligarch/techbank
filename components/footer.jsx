  ...
  return (
    <div className="p-8 bg-black">
      <div className="lg:flex lg:justify-between space-y-3 lg:space-y-0">
        <div>
          ...
          <div className="space-y-2">
            <p className="text-white">Suite 402 </p>
            <p className="text-white">Bihi towers , 4th floor</p>
            <p className="text-white">Nairobi , Kenya </p>
            <p className="text-white">info@techbank.co.ke </p>
            <p className="text-white">+254 781 234 205 </p>

            <br />
            <div className="flex space-x-6">
              <Link
                href="https://wa.link/55gfb9"
                target="_blank"
              ...
              <Link
                href="https://www.tiktok.com/@tech.bank"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image
              ...
              <Link
                href="https://www.instagram.com/techbank.ke?igsh=MTNyM3YwMWc5ampvdA=="
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image
      ...
      <div className="flex justify-center text-white">
        <p>Copyright ©  {new Date().getFullYear()} TechBank</p>
      </div>
    </div>
  );
}
